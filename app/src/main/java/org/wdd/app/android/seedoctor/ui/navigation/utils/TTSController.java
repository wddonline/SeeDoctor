package org.wdd.app.android.seedoctor.ui.navigation.utils;
...
public class TTSController implements AMapNaviListener {
    ...
    private InitListener mTtsInitListener = new InitListener() {
        ...
        public void onInit(int code) {
            if (code != ErrorCode.SUCCESS) {
                String error = mContext.getString(R.string.tts_init_error);
                AppToaster.show(String.format(error, code));
            } else {
    ...
    public void init() {
        SpeechUtility.createUtility(mContext, "appid=53bb77fb");
