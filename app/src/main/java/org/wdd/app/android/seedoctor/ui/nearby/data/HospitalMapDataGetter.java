...
public class HospitalMapDataGetter implements PoiSearch.OnPoiSearchListener {
    ...
    public HospitalMapDataGetter(ActivityFragmentAvaliable host, Context context) {
        this.host = host;
