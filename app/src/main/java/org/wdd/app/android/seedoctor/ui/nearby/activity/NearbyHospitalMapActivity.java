...
import org.wdd.app.android.seedoctor.ui.nearby.presenter.NearbyHospitalMapPresenter;
...
public class NearbyHospitalMapActivity extends BaseActivity implements AMap.OnCameraChangeListener,
    ...
    public static void show(Activity activity) {
        Intent intent = new Intent(activity, NearbyHospitalMapActivity.class);
...
//        Point point;
    ...
    public View getInfoWindow(Marker marker) {
        ...
        goButton.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                RouteLineActivity.show(NearbyHospitalMapActivity.this, poiItem.getLatLonPoint().getLatitude(),
